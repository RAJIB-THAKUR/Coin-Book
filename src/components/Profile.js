...
function Profile() {
  ...
  async function fetchprofdetail() {
    ...
    const response = await fetch(
      "https://coin-book-app-backend-mern4.onrender.com/user/fetch_User_Profile_Details",
      {
        method: "POST",
        headers: {
        ...
        <div className="d-flex justify-content-center">
          <div id="profilebox" className=" rounded">
            <div className="row">
              ...
              <div className="profelement col-sm-6 col-md-4 col-12">
                <p>Your Regular Expense Types :</p>
                <div class="dropdown">
                  <button
                  ...
                  <ul class="dropdown-menu">
                    {(() => {
                      ...
                      for (let i = 0; i < etypespresent.length; i++) {
                        rows.push(
                          <li>
                            <button class="dropdown-item" type="button" key={i}>
